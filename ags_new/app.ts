...
import { Dock, HoverArea, toggleWindow2 } from "./widget/Dock";
...
function main() {
	...
	for (const gdkmonitor of App.get_monitors()) {
		...
		bars.set(gdkmonitor, Dock(gdkmonitor, ["kitty", "zen", "obsidian", "wcm"]));
		toggleWindow2("dock");
		bars.set(gdkmonitor, HoverArea(gdkmonitor));
